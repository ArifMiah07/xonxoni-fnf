...
const BannerSection = () => {
    return (
        <section className="w-[350px] sm:w-[640px] md:w-[768px] lg:w-[1170px] mx-auto">
            <div className="img-bg hero min-h-screen drop-shadow-2xl" >
                {/* style={{ backgroundImage: "url('../../assets/images/cover.jpg')", backgroundPosition: 'center', backgroundRepeat: 'no-repeat', width: 'full', height: 'full', backgroundSize: 'cover' , clipPath: "polygon(0 0, 100% 0%, 100% 90%, 0% 100%)" }} */}
